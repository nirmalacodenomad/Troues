    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-10">
              <form action="{{ route('admin.equipment_booking.report') }}" method="GET">
                <div class="row no-gutters align-items-end">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <select class="form-control select2" name="vendor">
                        <option disabled value="">{{ __('Please Select') }}</option>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <button type="submit" class="btn btn-primary btn-md ml-lg-3 card-header-button">
                        {{ __('Submit') }}
                      </button>
                    </div>
                  </div>
            ...
            <div class="col-lg-2">
              <a href="{{ route('admin.equipment_booking.export_report') }}"
                        ...
                        <tr>
                          ...
                          <td>
                            @if (is_null($booking->discount))
                              -
                            @else
                              {{ $booking->currency_symbol_position == 'left' ? $booking->currency_symbol . ' ' : '' }}{{ $booking->discount }}{{ $booking->currency_symbol_position == 'right' ? ' ' . $booking->currency_symbol : '' }}
                            @endif
                          </td>
                          <td>
                            @if (is_null($booking->shipping_cost))
                              -
                            @else
                              {{ $booking->currency_symbol_position == 'left' ? $booking->currency_symbol . ' ' : '' }}{{ $booking->shipping_cost }}{{ $booking->currency_symbol_position == 'right' ? ' ' . $booking->currency_symbol : '' }}
                            @endif
                          </td>
                          <td>
                            @if (is_null($booking->tax))
                              -
                            @else
                              {{ $booking->currency_symbol_position == 'left' ? $booking->currency_symbol . ' ' : '' }}{{ $booking->tax }}{{ $booking->currency_symbol_position == 'right' ? ' ' . $booking->currency_symbol : '' }}
                            @endif
                          </td>
                          <td>
