                                ...
                                <select name="{{ $language->code }}_category_id" class="form-control">
                                  ...
                                  @foreach ($categories as $category)
                                    <option value="{{ $category->id }}"
                                      {{ ($productData ? $productData->product_category_id : '') == $category->id ? 'selected' : '' }}>
                                      {{ $category->name }}
                                    </option>
                                  @endforeach
                                </select>
                            ...
                            <div class="col-lg-12">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <textarea class="form-control summernote" name="{{ $language->code }}_content"
                                  placeholder="{{ __('Enter Content') }}" data-height="300">{{ is_null($productData) ? '' : replaceBaseUrl($productData->content, 'summernote') }}</textarea>
                              </div>
                            </div>
                          </div>
