        ...
        <div class="card-body">
          <div class="payment-information">
            <div class="row mb-2">
              ...
              <div class="col-lg-8">
                {{ $details->billing_first_name . ' ' . $details->billing_last_name }}
              </div>
            </div>
            ...
            <div class="row mb-2">
              ...
              <div class="col-lg-8">
                {{ $details->billing_contact_number }}
              </div>
            </div>
        ...
        <div class="card-body">
          <div class="payment-information">
            <div class="row mb-2">
              ...
              <div class="col-lg-8">
                {{ $details->shipping_first_name . ' ' . $details->shipping_last_name }}
              </div>
            </div>
            ...
            <div class="row mb-2">
              ...
              <div class="col-lg-8">
                {{ $details->shipping_contact_number }}
              </div>
            </div>
              ...
              <tbody>
                @foreach ($items as $item)
                  <tr>
                    ...
                    <td>
                      <a target="_blank"
                        href="{{ route('shop.product_details', $product_slug->slug) }}">{{ $item->title }}</a>
                    </td>
                    <td>{{ $item->quantity }}</td>
                    <td>
