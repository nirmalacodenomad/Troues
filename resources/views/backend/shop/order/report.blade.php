      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
                ...
                <div class="row no-gutters">
                  <div class="col-lg-2">
                    <div class="form-group">
                      <label>{{ __('From') }}</label>
                      <input name="from" type="text" class="form-control datepicker" placeholder="Select Start Date" value="{{ !empty(request()->input('from')) ? request()->input('from') : '' }}" readonly autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="col-lg-2">
                    <div class="form-group">
                      <label>{{ __('To') }}</label>
                      <input name="to" type="text" class="form-control datepicker" placeholder="Select To Date" value="{{ !empty(request()->input('to')) ? request()->input('to') : '' }}" readonly autocomplete="off">
                    </div>
                  </div>
                      ...
                      <select class="form-control h-42" name="payment_gateway">
                        ...
                        @if (count($offlineGateways) > 0)
                          @foreach ($offlineGateways as $offlineGateway)
                            <option value="{{ $offlineGateway->name }}" {{ request()->input('payment_gateway') == $offlineGateway->name ? 'selected' : '' }}>
                              {{ $offlineGateway->name }}
                            </option>
                          @endforeach
                        @endif
            ...
            <div class="col-lg-2">
              <a href="{{ route('admin.shop_management.export_report') }}" class="btn btn-success btn-sm float-lg-right card-header-button">
                  ...
                  <table class="table table-striped mt-2">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">{{ __('Billing Contact Number') }}</th>
                        ...
                        <th scope="col">{{ __('Shipping Contact Number') }}</th>
                    ...
                    <tbody>
                      @foreach ($orders as $order)
                        <tr>
                          ...
                          <td>{{ $order->billing_contact_number }}</td>
                          ...
                          <td>{{ $order->shipping_contact_number }}</td>
