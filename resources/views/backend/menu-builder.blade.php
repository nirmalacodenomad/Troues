              ...
              <div class="card border-primary mb-3">
                ...
                <div class="card-body">
                  <ul class="list-group">
                    ...
                    <li class="list-group-item">
                      {{ __('Equipment') }} <a href="" data-text="{{ __('Equipment') }}" data-type="equipment"
                        class="addToMenus btn btn-primary btn-sm float-right">{{ __('Add To Menus') }}</a>
                    </li>

                    <li class="list-group-item">
                      {{ __('Products') }} <a href="" data-text="{{ __('Products') }}" data-type="products"
                        class="addToMenus btn btn-primary btn-sm float-right">{{ __('Add To Menus') }}</a>
                    </li>
                    <li class="list-group-item">
                      {{ __('Vendors') }} <a href="" data-text="{{ __('Vendors') }}" data-type="vendor"
                        class="addToMenus btn btn-primary btn-sm float-right">{{ __('Add To Menus') }}</a>
                    </li>
