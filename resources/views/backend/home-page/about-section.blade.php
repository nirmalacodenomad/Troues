    ...
    <div class="col-md-6">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col">
              <div class="card-title">{{ __('Update About Section Image') }}</div>
            </div>
          </div>
        </div>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              <form id="aboutImgForm" action="{{ route('admin.home_page.update_about_section_image') }}" method="POST"
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              <form id="aboutForm"
                action="{{ route('admin.home_page.update_about_section', ['language' => request()->input('language')]) }}"
                method="POST">
                @csrf
                <div class="row">
                  <div class="col-lg-6">
