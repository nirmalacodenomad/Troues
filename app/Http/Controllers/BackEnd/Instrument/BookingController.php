...
class BookingController extends Controller
{
  public function bookings(Request $request)
  {
    ...
    $bookingNumber = $vendor = $paymentStatus = $shippingType = $shippingStatus = null;
  ...
  public function updatePaymentStatus(Request $request, $id)
  {
    ...
    if ($request['payment_status'] == 'completed') {
      ...
      if ($vendor) {
        ...
        $earning->total_earning = $earning->total_earning + $booking->grand_total;
      }
      $earning->save();
      ...
      if ($vendor) {
        ...
        $vendor->amount = $vendor->amount + ($booking->grand_total - ($commission + $booking->tax));
        $vendor->save();
        $after_balance = $vendor->amount;

        $received_amount = ($booking->grand_total - ($commission + $booking->tax));
        ...
        // then, update the invoice field info in database
        $received_amount = $booking->grand_total;
        $after_balance = NULL;
        $pre_balance = NULL;
      }
